...
const menuItems = [
  { icon: Home, label: "Home", href: "/home" }, // ✅ Sửa từ '#' → '/home'
  { icon: Compass, label: "Explore", href: "/explore" }, // ✅ Sửa từ '#' → '/explore'
  { icon: BookmarkIcon, label: "Saved", href: "/saved" }, // ✅ Sửa từ '#' → '/saved'
  { icon: Users, label: "Following", href: "/following" }, // ✅ Sửa từ '#' → '/following'
  { icon: Settings, label: "Settings", href: "/settings" }, // ✅ Sửa từ '#' → '/settings'
];
